        ...
        <div className="flex items-center justify-center h-screen bg-gray-900 text-white">
            <div className="w-full max-w-sm p-8 space-y-6 bg-gray-800 rounded-lg shadow-lg border border-gray-700">
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full px-4 py-3 font-bold text-white bg-white hover:bg-gray-100 text-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 flex items-center justify-center space-x-3 border border-gray-300"
                >
